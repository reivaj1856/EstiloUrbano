            ...
            <div class="max-w-screen-lg mx-auto">
                ...
                <div class="divide-y divide-gray-300 mt-6">
                    ...
                    if ($id_usuario) {
                        ...
                        try {
                            $stmt = $conexion->prepare("SELECT r.*,s.precio AS precio, s.nombre AS nombre, u.nombre AS nombre_usu, u.apellido AS apellido FROM reservas r INNER JOIN empleados e ON e.id = r.id_empleado INNER JOIN usuarios u ON u.id = e.id_usuario INNER JOIN servicios s ON s.id = r.id_servicio WHERE r.id_usuario = ? ORDER BY r.fecha_reserva DESC, r.hora_reserva DESC");
                    ...
                    ?>
                            <div class="grid grid-cols-5 max-md:grid-cols-2 items-start justify-between gap-6 py-4">
                                ...
                                <div class="md:ml-auto">
                                    ...
                                    <form method="post" onsubmit="return confirm('¿Estás seguro de cancelar esta reserva?');" action="/app/controllers/ServiciosCliente/cancel_quote.php">
