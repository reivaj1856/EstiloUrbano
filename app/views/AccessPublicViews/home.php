    ...
    <div class="max-w-screen-xl max-md:max-w-lg mx-auto">
      <div class="bg-white p-6 sm:p-8">
        <div class="max-w-6xl mx-auto text-center">
          ...
          <div class="mt-6">
            <p class="text-slate-600 text-xl">Bienvenido a Estilo Urbano, uno de los mejores salones de belleza en Bolivia.

              <br>Nuestro centro de belleza ofrece tratamientos capilares centrados en tu salud y bienestar capilar, para lo cual trabajamos con productos orgánicos, sin amoníaco, gluten free y sin formol. Todos los productos con los que trabajamos en nuestro centro capilar son además veganos.

              <br>Los peluditos de la familia también son bienvenidos en nuestro salón de belleza pet friendly.

              <br>¡Vení y atendé las necesidades de tu cabello en manos profesionales!
            </p>
          </div>
      ...
      <div class="p-4 mx-auto lg:max-w-8xl md:max-w-8xl">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-4 gap-4 sm:gap-5">
            ...
            <a href="/app/views/AccessPublicViews/service-beauty.php" class="block">
              ...
              <div class="p-4">
                ...
                <div class="mt-2 flex items-center flex-wrap gap-2">
                  <h6 class="text-sm sm:text-base text-slate-900">Nuestro centro de belleza ofrece tratamientos capilares centrados en tu salud y bienestar capilar.</h6>
                </div>
              </div>
            </a>
          ...
          <div class="bg-white flex flex-col rounded-sm overflow-hidden shadow-md hover:scale-[1.01] transition-all relative">
            <a href="/app/views/AccessPublicViews/service-manicure-and-pedicure.php" class="block">
              ...
              <div class="p-4">
                ...
                <div class="mt-2 flex items-center flex-wrap gap-2">
                  <h6 class="text-sm sm:text-base text-slate-900">te ofrecemos un Nailbar con los mejores manicures y pedicures de toda Bolivia. Somos expertas en fortalecer y restaurar uñas.</h6>
                </div>
              </div>
          ...
          <div class="bg-white flex flex-col rounded-sm overflow-hidden shadow-md hover:scale-[1.01] transition-all relative">
            <a href="/app/views/AccessPublicViews/service-hair-health.php" class="block">
              ...
              <div class="p-4">
                ...
                <div class="mt-2 flex items-center flex-wrap gap-2">
                  <h6 class="text-sm sm:text-base text-slate-900">la salud capilar es una prioridad absoluta, y esto se refleja en su enfoque holístico hacia el cuidado del cabello. .</h6>
                </div>
              </div>
            </a>
          ...
          <div class="bg-white flex flex-col rounded-sm overflow-hidden shadow-md hover:scale-[1.01] transition-all relative">
            <a href="/app/views/AccessPublicViews/service-make-up.php" class="block">
              ...
              <div class="p-4">
                ...
                <div class="mt-2 flex items-center flex-wrap gap-2">
                  <h6 class="text-sm sm:text-base text-slate-900">Nuestros servicios de estética incluyen los mejores maquillajes y peinados. Ya sea para graduaciones, bodas, fiestas, aniversarios, bautizos, cumpleaños u otros eventos.</h6>
                </div>
              </div>
            </a>
