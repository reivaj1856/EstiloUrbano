  ...
  ">
    ...
    <div class="px-4 py-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:max-w-6xl max-w-2xl mx-auto">
            <div class="text-left">
                <h2 class="text-slate-900 text-3xl font-bold mb-6">Maniquiur y pedicure</h2>
            ...
            <div>
                <img src="https://thenailbarspany.com/wp-content/uploads/2024/09/2728.jpg" alt="hero Image" class="rounded-lg object-contain w-full h-full" />
            </div>
        </div>
    </div>
