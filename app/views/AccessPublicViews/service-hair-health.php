  ...
  ">
    ...
    <div class="px-4 py-8">
        <div class="grid lg:grid-cols-2 gap-12 lg:max-w-6xl max-w-2xl mx-auto">
            <div class="text-left">
                <h2 class="text-slate-900 text-3xl font-bold mb-6">Salud Capilar</h2>
                <p class="mb-4 text-[15px] text-slate-600 leading-relaxed">En Dushi Salón, la salud capilar es una prioridad absoluta, y esto se refleja en su enfoque holístico hacia el cuidado del cabello. Utilizando tecnología avanzada y técnicas especializadas, el salón ofrece una experiencia única en diagnóstico y tratamiento capilar. Desde la evaluación detallada del estado de la piel capilar hasta la implementación de métodos personalizados para su cuidado y mejora.</p>
                <p class="mb-8 text-[15px] text-slate-600 leading-relaxed">Dushi Salón se esfuerza por asegurar que cada cliente reciba un servicio a la medida de sus necesidades. Este compromiso con la excelencia y la personalización es lo que distingue a Dushi Salón en el campo de la salud capilar.</p>
                <button type="button"
            ...
            <div>
                <img src="https://www.dermahg.es/wp-content/uploads/2019/07/Salud_Capilar.jpg" alt="hero Image" class="rounded-lg object-contain w-full h-full" />
            </div>
        </div>
    </div>
        ...
        <div class="divide-y divide-gray-200">
            ...
            <div class="accordion" role="accordion">
                <button type="button"
                    ...
                    <span class="mr-4">Escaner Diagnostico Capilar</span>
                ...
                <div class="content invisible max-h-0 overflow-hidden transition-all duration-300">
                    <p class="text-sm text-slate-600 leading-relaxed mb-1">Con el Escaner Capilar de Dushi Salón podemos determinar problemas de grasa, caída, caspa, sensibilidad, ademas de conocer la nutrición e hidratacion de la hebra del cabello. 30 minutos
                    </p>
                    <p class="text-sm text-yellow-600 leading-relaxed">150 Bs
                    </p>
                </div>
            </div>
            ...
            <div class="accordion" role="accordion">
                <button type="button"
                    class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-6 text-slate-900 hover:text-blue-600 flex items-center">
                    <span class="mr-4">Escaner + DETOX CAPILAR + blower</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42" class="w-3 fill-current ml-auto shrink-0">
                        <path class="plus"
                            d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" />
                        <path
                ...
                <div class="content invisible max-h-0 overflow-hidden transition-all duration-300">
                    <p class="text-sm text-slate-600 leading-relaxed mb-1">75 minutos
                    </p>
                    <p class="text-sm text-yellow-600 leading-relaxed">370 Bs
                    </p>
                </div>
            </div>
            ...
            <div class="accordion" role="accordion">
                <button type="button"
                    class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-6 text-slate-900 hover:text-blue-600 flex items-center">
                    <span class="mr-4">Tratamiento Curl Expression</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42" class="w-3 fill-current ml-auto shrink-0">
                        <path class="plus"
                            d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" />
                        <path
            ...
            <div class="accordion" role="accordion">
                <button type="button"
                    class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-6 text-slate-900 hover:text-blue-600 flex items-center">
                    <span class="mr-4">Cierre técnico Sellador de Color</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42" class="w-3 fill-current ml-auto shrink-0">
                        <path class="plus"
                            d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" />
                        <path
                ...
                <div class="content invisible max-h-0 overflow-hidden transition-all duration-300">
                    <p class="text-sm text-slate-600 leading-relaxed mb-1">No incluye blower. 90 minutos
                    </p>
            ...
            <div class="accordion" role="accordion">
                <button type="button"
                    class="toggle-button cursor-pointer w-full text-base outline-none text-left font-semibold py-6 text-slate-900 hover:text-blue-600 flex items-center">
                    <span class="mr-4">Sesion de Choque tratamiento detox</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42 42" class="w-3 fill-current ml-auto shrink-0">
                        <path class="plus"
                            d="M37.059 16H26V4.941C26 2.224 23.718 0 21 0s-5 2.224-5 4.941V16H4.941C2.224 16 0 18.282 0 21s2.224 5 4.941 5H16v11.059C16 39.776 18.282 42 21 42s5-2.224 5-4.941V26h11.059C39.776 26 42 23.718 42 21s-2.224-5-4.941-5z" />
                        <path
                ...
                <div class="content invisible max-h-0 overflow-hidden transition-all duration-300">
                    <p class="text-sm text-slate-600 leading-relaxed mb-1">Presentas problemas de grasa, caída, caspa? o Simplemente deseas realizarte una desintoxicación capilar para restaurar tu cabello sometido a estrés atmosférico, mecánicos y contaminación, este servicio es tu mejor opción incluye blower y acabado. 60 minutos
                    </p>
                    <p class="text-sm text-yellow-600 leading-relaxed">370 Bs
                    </p>
                </div>
    ...
    <div class="p-4 mx-auto lg:max-w-6xl md:max-w-4xl">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div class="bg-white flex flex-col rounded-sm overflow-hidden shadow-md hover:scale-[1.01] transition-all relative">
                <a href="/app/views/AccessPublicViews/service-beauty.php" class="block">
                    <div class="w-full">
                        <img src="https://impulsapopular.com/wp-content/uploads/2019/06/4504-Pasos-para-abrir-un-sal%C3%B3n-de-belleza.jpg" alt="Product-1"
                            class="w-full aspect-[18/24] object-cover object-right" />
                    </div>
                    <div class="p-4">
                        <h5 class="text-sm sm:text-base font-semibold text-slate-900 line-clamp-2">Salon de belleza</h5>
                    </div>
                </a>
