        ...
        <div
          ...
          <ul
            ...
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3">
              <a
                href="/app/views/Admin/homeSupervisor.php"
                class="hover:text-yellow-400 text-[18px] font-semibold text-gray-600 block">información</a>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3">
              <a
                href="/app/views/Admin/historialPago.php"
                class="hover:text-yellow-400 text-[18px] font-semibold text-gray-600 block">Historial de pago</a>
            </li>

            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3">
              <a
                href="/app/views/Admin/reporteAtencion.php"
                class="hover:text-yellow-400 text-gray-600 text-[18px] font-semibold block">Reporte de atencion</a>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3">
              <a
                href="/app/controllers/serviciosAdmin/generarReporte.php"
                class="hover:text-yellow-400 text-gray-600 text-[18px] font-semibold block">Reporte de ingresos</a>
            </li>
            <li class="max-lg:border-b max-lg:border-gray-300 max-lg:py-3">
              <a
                href="/app/views/loginViews/registerEmpleeoye.php"
                class="hover:text-yellow-400 text-gray-600 text-[18px] font-semibold block">Registrar</a>
            </li>
        ...
        <div class="max-w-screen-xl mx-auto">
            <div class="border-b border-gray-300 pb-4">
                <div class="flex gap-4">
                    <h3 class="text-2xl font-semibold text-slate-900">Reporte de atencion</h3>
                    <div class="ml-auto">
                        <select class="appearance-none cursor-pointer bg-gray-100 hover:bg-gray-200 border border-gray-300 outline-0 px-4 py-2 rounded-md text-[15px]">
                            <option>Servicios confirmados</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <?php
            // Consulta para obtener todos los servicios con estado 'confirmado'
            $sql = "SELECT r.*, u.nombre as Unombre, s.nombre as Snombre, r.fecha_reserva as fecha, u.apellido as Uapellido, u2.nombre as U2nombre, u2.apellido as U2apellidos
                    FROM reservas r
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 items-center justify-between gap-x-4 gap-y-6 py-4">
                            <div>
                                <h6 class="text-[15px] font-medium text-slate-900">
                                    <?php echo htmlspecialchars($row['Snombre'] ?? 'NO DEFINIDO'); ?>
                                </h6>
                                <div class="mt-2">
                                    <p class="text-[15px] text-slate-500 font-medium">
                                        Atencion ID: <span class="ml-1 text-slate-900">#<?php echo $row['id']; ?></span>
                                    </p>
                                </div>
                            </div>
                            <div>
                                ...
                                <p class="text-[15px] text-slate-900 font-medium mt-2">
                                    <?php echo isset($row['fecha']) ? date('d/m/Y', strtotime($row['fecha'])) : 'NO DEFINIDO'; ?>
                                </p>
                            </div>
                            <div>
                                <h6 class="text-[15px] font-medium text-slate-500">Estado</h6>
                                <p class="bg-green-100 text-[15px] font-medium text-green-600 mt-2 inline-block rounded-md py-1.5 px-3">
                                    <?php echo htmlspecialchars($row['estado']); ?>
                                </p>
                            </div>
                            <div>
                                <h6 class="text-[15px] font-medium text-slate-500">Cliente</h6>
                                <p class="text-[15px] text-slate-900 font-medium mt-2">
                                    <?php echo htmlspecialchars($row['Unombre']) . " " .  htmlspecialchars($row['Uapellido']); ?>
                                </p>
                            </div>
                            <div>
                                <h6 class="text-[15px] font-medium text-slate-500">Estilista a cargo</h6>
                                <p class="text-[15px] text-slate-900 font-medium mt-2">
                                    <?php echo htmlspecialchars($row['U2nombre']) . " " .  htmlspecialchars($row['U2apellidos']); ?>
                                </p>
                            </div>
                        </div>
                    <?php endwhile; ?>
            ...
            <?php else: ?>
                <div class="mt-6 text-center text-slate-500">No hay servicios confirmados.</div>
            <?php endif; ?>
        </div>
    </div>
