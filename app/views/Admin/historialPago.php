        ...
        <div class="max-w-screen-xl mx-auto">
            <div class="border-b border-gray-300 pb-4">
                <div class="flex gap-4">
                    <h3 class="text-2xl font-semibold text-slate-900">Historial de pagos</h3>
                    <div class="ml-auto">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 items-center justify-between gap-x-4 gap-y-6 py-4">
                            <div>
                                <h6 class="text-[15px] font-medium text-slate-900">
                                    <?php echo htmlspecialchars($row['metodo_pago'] ?? 'NO DEFINIDO'); ?>
                                </h6>
                                <div class="mt-2">
                                    <p class="text-[15px] text-slate-500 font-medium">
                                        Pago ID: <span class="ml-1 text-slate-900">#<?php echo $row['id']; ?></span>
                                    </p>
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                <h6 class="text-[15px] font-medium text-slate-500">Tipo de pago</h6>
                                <?php
                                if ($row['monto'] > 0) {
                                    echo '<p class="bg-green-100 text-[15px] font-medium text-green-600 mt-2 inline-block rounded-md py-1.5 px-3">'
                                        . htmlspecialchars($row['tipo_pago'] ?? 'NO DEFINIDO') .
                                        '</p>';
                                } else {
                                    echo '<p class="bg-red-600 text-[15px] font-medium text-white mt-2 inline-block rounded-md py-1.5 px-3">'
                                        . htmlspecialchars($row['tipo_pago'] ?? 'NO DEFINIDO') .
                                        '</p>';
                                }
                                ?>
                            ...
                            <div>
                                <h6 class="text-[15px] font-medium text-slate-500">Monto</h6>
                                <p class="text-[15px] text-slate-900 font-medium mt-2">
                                    $<?php echo number_format($row['monto'], 2); ?>
                                </p>
                            </div>
                            <div>
                                <h6 class="text-[15px] font-medium text-slate-500">Descripcion</h6>
                                <p class=" text-[15px] font-medium text-green-600 mt-2 inline-block ">
                                    <?php echo htmlspecialchars($row['descripcion'] ?? 'NO DEFINIDO'); ?>
                                </p>
                            </div>
                        </div>
                    <?php endwhile; ?>
            ...
            <?php else: ?>
                <div class="mt-6 text-center text-slate-500">No hay pagos registrados.</div>
            <?php endif; ?>
        </div>
    </div>
